      ...
      <div className="dashboard-section">
        ...
        {showForm && (
          <form className="product-form" onSubmit={handleSubmit}>
            ...
            <div className="form-row">
              ...
              <div className="form-group">
                ...
                <select name="category" value={formData.category} onChange={handleInputChange}>
                  <option value="crafts">Crafts</option><option value="food">Food</option>
            ...
            <div className="form-group">
              ...
              <textarea name="description" value={formData.description} onChange={handleInputChange} placeholder="Describe your product..." rows="4"></textarea>
            </div>
        ...
        {products.length > 0? (
          <div className="products-table">
            <table><thead><tr><th>Product</th><th>Price</th><th>Sales</th><th>Revenue</th></tr></thead>
              <tbody>{products.map(p => (<tr key={p.id}><td>{p.name}</td><td>ZMW {p.price}</td><td>{p.sales}</td><td>ZMW {(p.price * p.sales).toFixed(2)}</td></tr>))}</tbody>
            </table>
          </div>
